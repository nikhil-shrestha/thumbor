...
def print_results(warnings, errors):
    ...
    print(
        f"{Fore.CYAN}If you don't know how to fix the above problems, please open an issue with thumbor."
    )
    print(
        f"{Fore.CYAN}Don't forget to copy this log and add it to the description."
    )
